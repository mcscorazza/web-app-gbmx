              ...
              <div className="container mx-auto p-4">
                <div className="mb-4">
                  ...
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    ...
                    <div className='font-light text-md text-teal-300'>          000001                  </div>
                  </div>
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    <div className='font-extralight text-md'>                       ID Trem:              </div>
                    <div className='font-light text-md text-teal-300'>          HTT 98765-4                  </div>
                  </div>
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    <div className='font-extralight text-md'>                       Qtde vagões na composição:              </div>
                    <div className='font-light text-md text-teal-300'>          135 vgs                  </div>
                  </div>
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    <div className='font-extralight text-md'>                       # Vagão de Monitoramento:              </div>
                    <div className='font-light text-md text-teal-300'>          02                  </div>
                  </div>
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    <div className='font-extralight text-md'>                       Início da Viagem:              </div>
                    <div className='font-light text-md text-teal-300'>          06.03.2024 08h57                  </div>
                  </div>
                  <div className='w-full flex flex-row justify-between border-b border-gray-500 py-2'>
                    <div className='font-extralight text-md'>                       Conclusão da Viagem:              </div>
                    <div className='font-light text-md text-teal-300'>          08.03.2024 14h18                  </div>
                  </div>
